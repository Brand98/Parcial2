...
namespace Gps
{
    class GestorGPS
    {
        ...
        public Punto ConsultarCoordenadas()
        {
            ...
            int x = 0;
            var client = new RestClient($"http://18f2fec1.ngrok.io/API/index.php/select");
        ...
        public async void mandarCoordenadas(double x1, double y1)
        {
            ...
            var response = await client.PostAsync("http://18f2fec1.ngrok.io/API/index.php/insertar", content);
